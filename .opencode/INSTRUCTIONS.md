# Antigravity Kit - Global Instructions
...
- **Rule Priority:** P0 (INSTRUCTIONS.md) > P1 (Agent .md) > P2 (SKILL.md). All rules are binding.
...
| Script | Path |
|--------|------|
| Full verify | `.opencode/scripts/verify_all.py` |
| Checklist | `.opencode/scripts/checklist.py` |
| Security scan | `.opencode/skills/vulnerability-scanner/scripts/security_scan.py` |
| UX audit | `.opencode/skills/frontend-design/scripts/ux_audit.py` |
| Mobile audit | `.opencode/skills/mobile-design/scripts/mobile_audit.py` |
| Lighthouse | `.opencode/skills/performance-profiling/scripts/lighthouse_audit.py` |
| Playwright | `.opencode/skills/webapp-testing/scripts/playwright_runner.py` |
