...
CREATE INDEX `machine_telemetry_machine_idx` ON `machine_telemetry` (`machine_id`);--> statement-breakpoint
ALTER TABLE `stock_items` ADD `code` text;--> statement-breakpoint
ALTER TABLE `stock_items` ADD `label` text;