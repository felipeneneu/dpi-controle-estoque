...
const { getAutoImposerPath, getIllustratorImposerPath } = require('../utils/path-resolver');

function registerImpositionOrchestratorIpc() {
  // 1. Inspeciona o arquivo arrastado (dimensões preliminares e tags de bobina no nome)
  ipcMain.handle('imposition:inspect-file', async (_, filePath) => {
...
module.exports = { registerImpositionOrchestratorIpc };
